onEvent('recipes', event => {
    ...
    event.recipes.createMixing('create:chromatic_compound', ['botania:elementium_ingot', 'create:cinder_flour', Fluid.of('createbigcannons:molten_nethersteel', 30)]).superheated()
